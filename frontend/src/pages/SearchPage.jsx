...
function addRecent(inf) {
  const r = [inf, ...getRecent().filter(v => v !== inf)].slice(0, MAX_RECENT)
      ...
      <div style={{ padding: '16px' }}>
            ...
            <div style={{
              ...
              <input
                style={{
                  ...
                  fontSize: 18, color: 'var(--ink)', fontFamily: 'var(--font-display)',
                  fontStyle: 'italic',
                }}
        ...
        {recent.length > 0 && (
          <div className="animate-up delay-1">
            <div style={{ fontSize: 11, fontWeight: 700, color: 'var(--muted)', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 10 }}>最近查詢</div>
        ...
        {recent.length === 0 && (
          <div className="animate-up delay-2" style={{ textAlign: 'center', padding: '40px 16px', color: 'var(--muted)' }}>
            ...
            <div style={{ fontSize: 14 }}>輸入任意西班牙文動詞變化形</div>
          </div>
        )}
      </div>
    </div>
